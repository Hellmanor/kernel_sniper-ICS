...
#if 0
#define OMAP3630_VDD_MPU_OPP50_UV		920000
#define OMAP3630_VDD_MPU_OPP100_UV		1000000
#define OMAP3630_VDD_MPU_OPP120_UV		1200000
...
static struct omap_opp_def __initdata omap36xx_opp_def_list[] = {
	...
	/* MPU OPP2 - OPP100 */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,  550000000, OMAP3630_VDD_MPU_OPP100_UV),
	/* MPU OPP3 - OPP-Turbo */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				800000000, OMAP3630_VDD_MPU_OPP120_UV),
	/* MPU OPP4 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				1050000000, OMAP3630_VDD_MPU_OPP1G_UV),
